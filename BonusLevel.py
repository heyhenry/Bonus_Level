...
def show_go_screen():
    ...
    draw_text(screen, "BONUS LEVEL!", 64, WIDTH / 2, HEIGHT / 4)
...
player_img = pygame.image.load(path.join(img_dir, "socky.png")).convert_alpha()
player_mini_img = pygame.transform.scale(player_img, (25, 19))
player_mini_img.set_colorkey(BLACK)
mob_img = pygame.image.load(path.join(img_dir, "spider.png")).convert_alpha()
...
mob_death_sound = pygame.mixer.Sound(path.join(snd_dir, 'sdeath.wav'))
